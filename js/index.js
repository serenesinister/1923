...
const historia = {// criando uma constante, chamada historia para armazenar o conteúdo de cada "página" do GameBook
    ...
    {          // note que "pagina 0_0" foi nomeada com _ para não comprometer o reconhecimento pelo editor
        ...
        audioNarracao: "audio/mary-s-theme-stelvio-cipriani.mp3",
    ...
    paginacapa:
    {
        ...
        audioNarracao: "audio/nao-somos-livres.mp3",
        opcoes: [
            {
    ...
    paginachorar: {
        ...
        audioNarracao: "audio/pagina-perdedor.mp3",
        opcoes: [
            {
    ...
    paginacidade: {
        ...
        audioNarracao: "audio/transeuntes.mp3",
        opcoes: [
            {
                texto: "PROSSEGUIR",
    ...
    paginapadaria: {
        ...
        audioNarracao: "audio/cafe-nao-ha-nada-a-fazer-aqui.mp3",
        opcoes: [
            {
    ...
    paginalamuria: {
        ...
        audioNarracao: "audio/lamuria.mp3",
        opcoes: [
            {
                texto: "NOVA JORNADA",
    ...
    paginajanela: {
        ...
        audioNarracao: "audio/apartamento-isabella.mp3",
        opcoes: [
            {
    ...
    paginamortecafe: {
        ...
        audioNarracao: "audio/rip-cafe.mp3",
        opcoes: [
            {
                texto: "NOVA JORNADA",
                proximaPagina: "pagina0_0"
    ...
    paginalcoolatra: {
        ...
        audioNarracao: "audio/rip-alcohol.mp3",
        opcoes: [
            {
                texto: "NOVA JORNADA",
                proximaPagina: "pagina0_0"
    ...
    paginaperseguir: {
        ...
        audioNarracao: "audio/despretensiosamente.mp3",
        opcoes: [
            {
                texto: "PROSSEGUIR",
    ...
    paginadecisaopub: {    
        ...
        audioNarracao: "audio/pub-da-esquina.mp3",
        opcoes: [
            {
    ...
    paginaficarpub: {
        ...
        audioNarracao: "audio/ressaca.mp3",
        opcoes: [
            {
    ...
    paginarollsroyce: {
        ...
        audioNarracao: "audio/rolls-royce-silver-ghost-1907.mp3",
        opcoes: [
            {
                texto: "NOVA JORNADA",
                proximaPagina: "pagina0_0"
    ...
    paginadesculpa: {
        ...
        audioNarracao: "audio/adam-hospicio.mp3",
        opcoes: [
            {
                texto: "NOVA JORNADA",
                proximaPagina: "pagina0_0"
    ...
    paginapedrada: {
        ...
        audioNarracao: "audio/adam-joga-pedra-isabella-socorre-invasor.mp3",
        opcoes: [
            {
                texto: "SE DESCULPAR",
    ...
    paginaconversamichelle: {
        ...
        audioNarracao: "audio/conversa-michelle-invasoes.mp3",
        opcoes: [
            {
    ...
    paginaaproximacao: {
        ...
        audioNarracao: "audio/adam-tomar-decisoes-rapidas.mp3",
        opcoes: [
            {
    ...
    paginadetetives: {
        ...
        audioNarracao: "audio/dupla-de-detetives-amadores.mp3",
        opcoes: [
            {
    ...
    paginaisabella: {
        ...
        audioNarracao: "audio/aproximar-isabella.mp3",
        opcoes: [
            {
    ...
    paginaprender: {
        ...
        audioNarracao: "audio/suspeito-preso-preventivamente.mp3",
        opcoes: [
            {
            texto: "NOVA JORNADA",
            proximaPagina: "pagina0_0"
    ...
    paginacordo: {
        ...
        audioNarracao: "audio/adam-faz-acordo.mp3",
        opcoes: [
            {
    ...
    paginafuga: {
        ...
        audioNarracao: "audio/suspeito-foge-adam-pensativo.mp3",
        opcoes: [
            {
    ...
    paginaperdedor: {
        ...
        audioNarracao: "audio/paradoxal-perdedor.mp3",
        opcoes: [
            {
    ...
    paginareputacao: {
        ...
        audioNarracao: "audio/acoes-adam-consequencias-pub.mp3",
        opcoes: [
            {
    ...
    paginafuienganado: {
        ...
        audioNarracao: "audio/adam-vacilao-caiu-no-papinho.mp3",
        opcoes: [
            {
                texto: "NOVA JORNADA",
                proximaPagina: "pagina0_0"
    ...
    paginaescape: {
        ...
        audioNarracao: "audio/livraria-entrar.mp3",
        opcoes:[
            {
    ...
    paginalivreto: {
        ...
        audioNarracao: "audio/livro-jogo-adam.mp3",
        opcoes:[
            {
                texto: "MATRIX • 1923",
    ...
    paginaespancar: {
        ...
        audioNarracao: "audio/caos-no-pub-adam-briga.mp3",
        opcoes: [
            {
                texto: "NOVA JORNADA",
                proximaPagina: "pagina0_0"
    ...
    paginamibella: {
        ...
        audioNarracao: "audio/michelle-dobra-aposta.mp3",
        opcoes: [
            {
    ...
    paginaconfissao: {
        ...
        audioNarracao: "audio/isabella-confessa.mp3",
        opcoes: [
            {
                texto: "DETALHES",
    ...
    paginadella: {
        ...
        audioNarracao: "audio/adam-segredos-isabella.mp3",
        opcoes: [
            {
    ...
    paginamichella: {
        ...
        audioNarracao: "audio/michelle-empatia.mp3",
        opcoes: [
            {
                texto: "DOBRAR APOSTA",
    ...
    paginacavalo: {
        ...
        audioNarracao: "audio/cavalo.mp3",
        opcoes: [
            {
    ...
    paginaquasefinal: {
        ...
        audioNarracao: "audio/invasores-distracao.mp3",
        opcoes: [
            {
    ...
    paginafodasela: {
        ...
        audioNarracao: "audio/bad-ending.mp3",
        opcoes: [
            {
    ...
    paginajuda: {
        ...
        audioNarracao: "audio/seita-revamped.mp3",
        opcoes: [
            {
                texto: "E O CORNO ?",
    ...
    paginacasamento: {
        ...
        audioNarracao: "audio/in-italy.mp3",
        opcoes: [
            {
                texto: "VOLTAR",
                proximaPagina: "paginajuda"
    ...
    pagina404: {
        ...
        audioNarracao: "audio/erro-404.mp3",
        opcoes: [
            {
                texto: "VOLTAR",
                proximaPagina: "paginajuda"
    ...
    paginaconsequencias: {
        ...
        audioNarracao: "audio/adam-michelle-ignoram.mp3",
        opcoes: [
            {
               texto: "NOVA JORNADA",
                proximaPagina: "pagina0_0"
    ...
    paginaideia: {
        ...
        audioNarracao: "audio/remorso.mp3",
        opcoes: [
            {
                texto: "AJUDAR ISABELLA",
                proximaPagina: "paginajuda"
